module.exports = {
  OWNER_IDS: ["552086701095387137"], // Bot owner ID's
  SUPPORT_SERVER: "https://discord.gg/QC2J9pM3", // Your bot support server
  PREFIX_COMMANDS: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "1371223698266132571", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#ff2a00",
    TRANSPARENT: "#36393F",
